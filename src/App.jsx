...
import DubaiCityTour from './pages/dubai-packages-book-now/DubaiCityTour.jsx';
...
import Form4 from './pages/visa-form4/Form4.jsx';
import Updated from './pages/visa-updated/Updated.jsx';
import LongVisa from './pages/long-stay-visa/LongVisa.jsx';
import MultipleVisa from './pages/multiple-entry-visa/MultipleVisa.jsx';
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/dubai-packages-book-now" element={<DubaiCityTour />} />
        ...
        <Route path="/visa-form4" element={<Form4 />} />
        <Route path="/visa-updated" element={<Updated />} />
        <Route path="/long-stay-visa" element={<LongVisa />} />
        <Route path="/multiple-entry-visa" element={<MultipleVisa />} />
