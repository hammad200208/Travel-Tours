...
const Hero = () => {
  return (
    <section
      ...
      style={{ backgroundImage: "url('private-cruise/bg.png')" }}
    >
      {/* Overlay */}
      <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-center px-4">
        <h1 className="text-3xl md:text-4xl font-poppins font-bold text-white mb-2 mt-20">
          Private Dubai Dhow Cruise
        </h1>
        <p className="text-lg md:text-lg font-poppins text-[#EAEAEA] max-w-4xl mb-6">
          Indulge in a 3-hour private cruise with a personal table, premium dinner, and exclusive Dubai skyline views.
        </p>
