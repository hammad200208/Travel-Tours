  ...
  return (
    ...
    <section className="w-full bg-[#F6B15C] py-20 text-center flex flex-col items-center justify-center">
      ...
      <h2 className="text-3xl md:text-4xl font-bold font-poppins text-white mb-4">
        Reserve Your Private Cruise Now
      </h2>

      {/* Paragraph */}
      <p className="text-[#FFF8EF] font-poppins text-lg max-w-4xl mb-8">
        Enjoy 3 hours of Dubai skyline, premium dinner, and an exclusive private experience on the water.
      </p>
