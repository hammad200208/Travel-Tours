      ...
      <div className="flex flex-col gap-4 items-center md:items-start">
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-2">
            <img src="/morning-desert-safari/time.png" className="w-4 h-4" />
            <p className="text-gray-700">4 hours</p>
          </div>

          <div className="flex items-center gap-2">
            <img src="/morning-desert-safari/user.png" className="w-4 h-4" />
            <p className="text-gray-700">Families & Adventure Seekers</p>
          </div>

          <div className="flex items-center gap-2">
            <img src="/morning-desert-safari/price.png" className="w-4 h-4" />
            <p className="text-gray-700">From AED 250</p>
          </div>

          <div className="flex items-center gap-2">
            <img src="/morning-desert-safari/date.png" className="w-4 h-4" />
