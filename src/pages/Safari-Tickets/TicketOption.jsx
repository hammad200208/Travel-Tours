      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-6">
        {tickets.map((item, index) => (
          ...
          >
            ...
            <h3 className="text-lg text-[#2B2B2B] font-poppins font-semibold mb-2">
              {item.title}
            </h3>

            <p className="text-[#4A4A4A] font-poppins text-sm mb-4">
              {item.desc}
            </p>

            <div className="flex justify-between w-full text-sm mb-4">
              <span className="text-[#777777] font-poppins">
                {item.duration}
              </span>
            ...
            <button
              ...
              className="bg-[#F49C0B] text-white py-2 px-6 rounded-xl hover:bg-[#f49b0bea] duration-200"
            >
              Book Now
            </button>
          </div>
